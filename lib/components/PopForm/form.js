...
function (_React$Component) {
  ...
  function MyForm(props) {
        ...
        switch (item.type) {
          ...
          case "week":
            ...
            return getFieldDecorator(item.keyName, {
              rules: _this.returnRoles(item.rules),
              initialValue: item.defaultValue
            })(_react["default"].createElement(WeekPicker, {
              disabled: item.disabled,
          ...
          case "month":
            ...
            return getFieldDecorator(item.keyName, {
              rules: _this.returnRoles(item.rules),
              initialValue: item.defaultValue
            })(_react["default"].createElement(MonthPicker, {
              disabled: item.disabled,
              disabledDate: item.disabledDate,
              locale: _zh_CN["default"],
              onChange: function onChange(date, dateString) {
          ...
          case "file":
            return getFieldDecorator(item.keyName, {
              rules: _this.returnRoles(item.rules),
              initialValue: item.defaultValue
            })(_react["default"].createElement(_upload["default"], _extends({}, item, {
    ...
    _this.formItemBox = _react["default"].createRef();
    return _this;
  }
  ...
  _proto.render = function render() {
    ...
    return _react["default"].createElement(_antd.Form, {
      ...
      return _react["default"].createElement(FormItem, _extends({}, formItemLayout, {
    ...
    })), withButtonContainter ? _react["default"].createElement("div", {
      className: "action-button-container",
      style: _objectSpread({}, buttonItemLayout)
    }, this.props.children, customButton ? _react["default"].createElement(_antd.Button, {
      ...
      type: "primary"
    }, customButton.text) : "", onOk ? _react["default"].createElement(_antd.Button, {
      htmlType: "submit",
      type: "primary"
    }, okText) : "") : null);
  };
...
MyForm.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  withButtonContainter: _propTypes["default"].bool,
  buttonItemLayout: _propTypes["default"].object,
...
var WrappedMyForm = _antd.Form.create()(MyForm);

var _default = WrappedMyForm;
