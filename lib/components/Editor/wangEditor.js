...
(function (global, factory) {
  ...
  */
  ...
  function getPasteHtml(e, filterStyle, ignoreImg) {
    ...
    console.log(pasteHtml, "12312"); // 过滤word中状态过来的无用字符
  ...
  */
  ...
  UploadImg.prototype = {
    ...
    uploadImg: function uploadImg(files) {
      ...
      var editor = this.editor;
      var config = editor.config;
      var uploadImgServer = config.uploadServer + "/data/saveData?reqCode=10001";
      var downImgServer = config.uploadServer + "/data/getData?reqCode=10001";
          ...
          if (xhr.readyState === 4) {
            ...
            if (result && JSON.parse(result)) {
              ...
              if (resultObj.state === "SUCCESS") {
                ...
                if (resultObj.key) {
                  var url = downImgServer + "&key=" + resultObj.key + "&fileName=" + resultObj.fileName;
    ...
    uploadFile: function uploadFile(files) {
      ...
      var hooks = config.uploadImgHooks || {};
      var timeout = config.uploadImgTimeout || 3000;
      var withCredentials = config.withCredentials; // ------------------------------ 验证文件信息 ------------------------------
      ...
      console.log(formdata, resultFiles, "123"); // ------------------------------ 上传文件 ------------------------------
