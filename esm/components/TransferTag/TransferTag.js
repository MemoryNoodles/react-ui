...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement("div", {
    ...
    }, React.createElement("span", null, targetTitle), React.createElement("span", {
      className: "transfer-box-title-btn",
      onClick: function onClick() {
        _this2.clearTarget();
      },
      onKeyPress: function onKeyPress() {}
    }, "\u6E05\u7A7A")), targetFilter && React.createElement(Search, {
      allowClear: true,
      ...
      }, item.label, " ", React.createElement(Icon, {
        onClick: function onClick() {
      ...
      className: "transfer-box-title"
    }, React.createElement("span", null, sourceTitle), React.createElement("span", {
      className: "transfer-box-title-btn primary",
      onClick: function onClick() {
        _this2.checkAllSourceData();
      },
      onKeyPress: function onKeyPress() {}
    }, "\u5168\u9009")), sourceFilter && React.createElement(Search, {
      allowClear: true,
      onChange: function onChange(e) {
        return _this2.setState({
